        ...
        >
            <div className="text-white py-5 flex justify-between items-center">
                ...
                <div className="text-lg font-semibold cursor-pointer">
                    <span className="text-white">Risudev</span>
                </div>
                ...
                <ul className="hidden md:flex space-x-8 text-gray-300">
                    {menuItems.map((item) => (
                        <li
                            key={item.id}
                            className={`group relative cursor-pointer ${activeSection === item.id ? "text-[#8245ec]" : "hover:text-[#8245ec]"
                                }`}
                        >
                            <button
                            ...
                            >
                                ...
                                {/* Underline animation */}
                                <span
                                    className={`absolute left-0 -bottom-1 w-0 h-[2px] bg-[#8245ec] transition-all duration-300 group-hover:w-full ${activeSection === item.id ? "w-full" : ""
                                        }`}
                                ></span>
                            </button>
                        </li>
